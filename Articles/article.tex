...
\begin{document}
	...
	The analytical result agree with the simulations.
	

	For one iteration, winner takes all is the same as winners take all.
	
	
	Winners take all better with errors instead of erasures.
