...
%	\end{align*}
	...
	$\eta_{m, \psi} = P_{retrieve} m  \frac{2 \left(c \log_2{\ell \choose a } - \log_2(m) + \frac{1}{\log 2} \right)}{c(c-1)l^2} \times (1-{\ell \choose a}^{c - c_e})^{-(m-1)} \times \frac{1}{1 + \psi \log_2(\psi) +(1-\psi) \log_2(1-\psi)} $
